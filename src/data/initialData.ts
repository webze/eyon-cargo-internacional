...
export const INITIAL_VEHICLES: Vehicle[] = [
  {
    ...
    notas: 'Unidad de cabecera familiar para rutas de alta montaña con freno retardador.',
    estado: 'Operativo',
    kmActual: 185200,
    ranfla: {
      placa: 'R3B-912',
      tipo: 'Plataforma 3 Ejes',
      marca: 'Randon',
      ejes: 3,
      notas: 'Carretea/Ranfla de 3 ejes con suspensión neumática y piñas para contenedores.',
      documentos: [
        {
          id: 'doc_r101',
          tipo: 'CITV Carretea / Ranfla',
          entidad: 'CITV Certificadora del Sur',
          fecha: new Date(Date.now() + 86400000 * 60).toISOString().slice(0, 10),
          numeroDoc: 'CITV-RANFLA-99120',
          notas: 'Inspección técnica vehicular de la carretera de 3 ejes activa.',
        },
        {
          id: 'doc_r102',
          tipo: 'Tarjeta Propiedad Ranfla',
          entidad: 'SUNARP',
          fecha: new Date(Date.now() + 86400000 * 365).toISOString().slice(0, 10),
          numeroDoc: 'SUNARP-TIT-99212',
          notas: 'Tarjeta de propiedad de la ranfla R3B-912 a nombre de la empresa.',
        },
      ],
    },
    mantenimientos: [
      {
        ...
        descripcion: 'Aceite de motor sintético heavy duty 15W40 + Filtros de aceite, diésel y separador',
        kmUltimoCambio: 180000,
        intervaloKm: 10000,
        fechaUltimoCambio: '2026-06-10',
        costoUltimoCambio: 1250,
      },
      {
        id: 'maint_2',
        tipo: 'Engrase General',
        descripcion: 'Engrase de crucetas, quinta rueda, bocinas y ejes de la ranfla',
        kmUltimoCambio: 183500,
        intervaloKm: 3000,
        fechaUltimoCambio: '2026-07-02',
        costoUltimoCambio: 180,
      },
      {
        id: 'maint_3',
        tipo: 'Rotación / Cambio de Llantas',
        descripcion: 'Alineación y rotación de llantas de tracción y ejes de ranfla',
        kmUltimoCambio: 160000,
        intervaloKm: 30000,
        fechaUltimoCambio: '2026-04-15',
        costoUltimoCambio: 3200,
      },
      {
        id: 'maint_4',
        tipo: 'Frenos y Suspensión',
        descripcion: 'Regulación de fajas de freno, revisión de pulmones de aire y zapatas',
        kmUltimoCambio: 175000,
        intervaloKm: 20000,
        fechaUltimoCambio: '2026-05-20',
        costoUltimoCambio: 1400,
      },
    ],
    gastos: [
      {
        ...
        fecha: '2026-07-15',
        categoria: 'Llantas',
        descripcion: 'Compra de 2 llantas Bridgestone 295/80R22.5 para ejes de ranfla',
        monto: 2400,
        km: 184500,
        mecanicoOTaller: 'Llantas del Sur EIRL',
      },
      {
        id: 'exp_2',
        fecha: '2026-06-10',
        categoria: 'Aceite y Filtros',
        descripcion: 'Cambio de lubricante Mobil Delvac 15W40 + kit completo de 4 filtros',
        monto: 1250,
        km: 180000,
        mecanicoOTaller: 'Taller Central Volvo Ate',
      },
      {
        id: 'exp_3',
        fecha: '2026-07-01',
        categoria: 'Repuestos y Accesorios',
        descripcion: 'Compra de kit de luces LED, cables de 7 vías para ranfla y fajas rachet',
        monto: 680,
        km: 183000,
        mecanicoOTaller: 'Comercial Repuestos El Camionero',
      },
    ],
    documentos: [
      {
